// Nebius Inference API embedder для fsqr.
// Модель: Qwen/Qwen3-Embedding-8B (1024 dimensions).
package main
...
// NebiusEmbedder вызывает Nebius Inference API для получения эмбеддингов.
